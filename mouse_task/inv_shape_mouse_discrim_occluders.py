"""
Discrimination task with 2 occluders of different sizes, wider occluders.
...
class InvShapeDiscrimOccluders(ActiveSensingTask):
    """
    Shape discrimination task,  with occluders of different sizes
    The mouse must report the location of the black teardrop object and ignore the wide Pacman.
    """
    ...
    def __init__(
        ...
        write_video=False,
        fps=60.0,
        session_label=["ar_shape_discrim_occluders_inv"],
        epochs=[250],
        ...
        slit_depth=0.02,
        target_selection=4.0, # changed 13. to 4. --> black teardrop
        distractor_selection=9.0, # changed 6. to 9. --> black pacman
        occlusion_type=1.0,
        camera_type=1.0,
        target_spread=4.0,
