"""
Discrimination task with multiple occluder widths.
...
class InvShapeDiscrimMultiOccluders(ActiveSensingTask):
    """
    ...
    def __init__(
        ...
        write_video=False,
        fps=60.0,
        session_label=["ar_shape_discrim_multi_occluders_inv"],
        epochs=[250],
