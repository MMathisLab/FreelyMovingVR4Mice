...
class InvDetectionVelThrTask(ActiveSensingTask):

    """
    Detection task with velocity threshold to initiate the trials.
    
    Black teardrop as target, with velocity threshold.
    """
    ...
    def __init__(
        ...
        write_video=False,
        fps=60.0,
        session_label=["ar_detection_velthr_inv"],
        epochs=[250],
        ...
        slit_depth=0.2,
        target_selection=4.0, # changed to 4.0 from 6.0, black teardrop
        distractor_selection=6.0, # changed to 6.0 from 4.0, white teardrop
        occlusion_type=0.0,
        camera_type=1.0,
        target_spread=4.0,
        target_rotation=0,
