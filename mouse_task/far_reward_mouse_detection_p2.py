...
class FarDetectionWithVelocityThresholdTask(ActiveSensingTask):

    """
    Detection task with velocity threshold to initiate the trials.
    Reward ports are further away from the screen, by ~2 cm, compared to DetectionWithVelocityThresholdTask.
    """
    ...
    def __init__(
        ...
        r_report_box=[5, 10, -6, -4], # changed from [5, 10, -4, -2]
        l_report_box=[-10, -5, -6, -4], # changed from [-10, -5, -4, -2]
