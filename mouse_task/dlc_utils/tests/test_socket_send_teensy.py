...
class MyProcessor_socket:
    def __init__(self, com, baudrate=9600, inputs=["S", "seconds"], save_file_path = "/Users/thomassainsbury/Documents/Mathis_lab/Mathis_lab_code/FreelyMovingVR4Mice/mouse_task/tests/"):
        super().__init__()
