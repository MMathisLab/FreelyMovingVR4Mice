...
for episode in range(3):
  ...
  while not done:
    ...
    action = spec.action_spec.random_action(len(decision_steps))  #(len(decision_steps))
    print(action.continuous)
    random_action = np.array([-0.04102117, -9.93074882,  0.59740335], dtype=np.float32).reshape(1,-1)
    print(random_action)
