...
Then save this file as `vr4mice.bat`. If you get an error saying that the command prompt could not find the `activate` command, then follow this [tutorial](https://www.edureka.co/community/163047/conda-is-not-recognized-as-internal-or-external-command) to add conda to your machine's PATH variable. You should then be able to simply click on this icon on your desktop to load the GUI!
