...
```{warning}
Close the program using the GUI's <u>**Stop**</u> and <u>**Close**</u> buttons, and <u>**NOT**</u> via keyboard shortcuts. This is to avoid unexpected behavior.
```
