...
1. set up conda environment: (_if --name option is omitted the default name of conda environment is vr4mice_) Note: can take some time for pip dependencies, no panic
```
