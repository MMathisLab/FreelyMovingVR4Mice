...
```{figure} ../../docs/images/floor_coating_diagram.png
:alt: Floor plate coating diagram
:class: bg-primary mb-1
:width: 400px
:align: center

The front of the floor plate (i.e. closest to SCREEN 2, the main screen) should have the larger anti-glare material patch (i.e. patch 1) and the back of the floor plate should have the smaller one (i.e. patch 2).
```
...
```{figure} ../../docs/images/assembled_perspex_box.jpeg
:alt: Box front
:class: bg-primary mb-1
:width: 400px
:align: center
...
```{figure} ../../docs/images/plate_sheet_plate.png
:class: bg-primary mb-1
:width: 400px
:align: center
:alt: Light diffuser
