...
The computer monitors can then be mounted on the 3D printed holders by placing each on on the bottom monitor holders and then adjusting the top monitor holders so that the monitor sits within the plastic groves. Tighten these screws so that the monitors are held securely.
