...
If a game is updated in the `FreelyMovingVR4Mice` repository (see {doc}`../../docs/Unity_games/update_Unity_Game` if you want to update a game), you will need to rebuild the game entirely. Here are the steps to do so.
