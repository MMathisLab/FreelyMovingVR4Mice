# Game parameters for all training stages

## Training Stage 1: Detection task

### Step 1: permissive trial initiation parameters
...
### Step 2: restricted trial initiation parameters
...
## Training Stage 2: Discrimination without occlusion parameters
...
## Training Stage 3: Discrimination with occlusion parameters
