...
# TODO(celia): rewrite this with the new functions.
def vr4mice_summary_plots(
    key, save_path="/Users/thomassainsbury/Documents/Mathis_lab/Aug_Reg/", database=True
):
    """
    ...
    # check if exists:
    full_path = base_analysis.OutputPlots.get_path(base=save_path, key=key, ext=".png")
