...
data = {
    ...
    "Anesthesia": [
        ...
        {
            "anesthesia_name": "isoflurane",
            "anesthesia_details": "mouse is under gas anesthesia, ~4-5 Percent induction, ~1 Percent maintenance",
        },
        {
            "anesthesia_name": "ketamine",
            "anesthesia_details": "mouse is anesthetized to near surgical plane with K/X mixture: 87.5 mg/kg Ketamine + 12.5 mg/kg Xylazine",
        },
    ],
    ...
    "OptogeneticsVariant": [
        {"opto_variant_name": "none", "opto_variant_details": "no optogenetics used"}
    ],
    "opto_name": ["none", "test3", "Mathis2017"],
    "Task": [
        {
            "task_name": "AR_visual_discrimination",
            "task_details": "mouse in AR has to decide which side a white cube is on by reporting its location at the lick port",
        }
    ],
    ...
    "MouseScoreSheet_GeneralAssay": [
        {
            "general_assay": "Assay1",
            "define_score": "1 or less euthanize cannot be aroused",
        },
        {
